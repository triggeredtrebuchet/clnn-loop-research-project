...
def three_CNN_LSTM1(x_train, y_train, x_val, y_val, x_test, y_test, learning_rate, INPUT_SHAPE, KERNEL_NUMBER, KERNEL_SIZE, LSTM_UNITS, name="best_two_CNN_LSTM.txt"):
    model = Sequential()
